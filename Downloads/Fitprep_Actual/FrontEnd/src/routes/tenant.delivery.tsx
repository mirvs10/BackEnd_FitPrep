...
function Delivery() {
  ...
  return (
    <MockupShell breadcrumbs={["FitKitchen", "Logística", "Pedidos y Entregas"]}>
      <div className="p-8">
        <PageHeader eyebrow="Operación logística" title="Gestión de pedidos y entregas" description="Estado y despacho de los pedidos en tiempo real." actions={<Btn onClick={() => queryClient.invalidateQueries({ queryKey: ["negocioPedidos"] })}>Actualizar lista</Btn>} />
