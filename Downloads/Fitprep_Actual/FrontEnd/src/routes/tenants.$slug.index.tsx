...
function TenantProfile() {
  ...
  const name = slug === "fitkitchen" ? "FitKitchen Madrid" : slug;
  return (
      ...
      <div className="px-8 -mt-16 max-w-6xl mx-auto pb-12">
        <Card className="p-7">
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            <div className="size-24 rounded-2xl bg-brand-100 border border-border grid place-items-center text-2xl font-bold text-brand-700">FK</div>
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-muted-foreground mt-1">Cocina mediterránea optimizada para deportistas · Entregas Lun-Vie</p>
