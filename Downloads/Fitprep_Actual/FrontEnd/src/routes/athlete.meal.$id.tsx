        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex items-center gap-4 mt-2 text-xs text-muted-foreground">
              ...
              <Link to="/tenants/$slug" params={{ slug: plato.negocioId === 2 ? 'gymforce' : 'fitkitchen' }} className="flex items-center gap-1 font-semibold text-brand-600 hover:underline ml-2">
