...
function Meals() {
  ...
  return (
    <MockupShell breadcrumbs={["FitKitchen", "Catálogo"]}>
      <div className="p-8">
        <PageHeader eyebrow="Operación" title="Catálogo de comidas" description={`${platos?.length || 0} platos publicados en tu catálogo`} actions={<Link to="/tenant/meals/new"><Btn><Plus className="size-3.5" /> Nueva comida</Btn></Link>} />
