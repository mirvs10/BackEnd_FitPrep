      ...
      <div className="p-8 max-w-5xl">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-5">
            ...
            <Card className="p-6">
              <h3 className="text-sm font-semibold mb-4">Ingredientes</h3>
              <div className="flex flex-wrap gap-2 mb-3">
                {["Pollo (180g)","Quinoa (90g)","Limón","Brócoli","Aceite oliva"].map(i => <span key={i} className="px-2.5 py-1 rounded-full bg-brand-50 text-brand-700 text-xs font-medium">{i} ×</span>)}
              </div>
              <Field label="" placeholder="Buscar o agregar ingrediente..." />
            </Card>
          </div>
