...
const tenantGroups: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/tenant/ingredients", label: "Ingredientes", icon: Carrot },
      { to: "/tenant/shopping", label: "Lista compras", icon: ShoppingBasket },
    ],
  },
  {
    title: "Negocio",
    items: [
      ...
      { to: "/tenant/stats", label: "Estadísticas", icon: BarChart3 },
      { to: "/tenant/settings", label: "Configuración", icon: Cog },
    ],
  },
];
